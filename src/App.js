...
class App extends React.Component {
  ...
  handleOnSubmit(e) {
    ...
    window.location.href =
      `https://be.synxis.com/?adult=${this.state.adults}&arrive=${format(this.state.check_in, 'yyyy-MM-dd')}&chain=25518&child=${this.state.kids}&currency=COP&depart=${format(this.state.check_out, 'yyyy-MM-dd')}&hotel=8717&level=hotel&locale=es-MX&rooms=1&promo=${this.state.promo_code}`;
  }
